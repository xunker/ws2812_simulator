...
# Init
n = 64 # num leds
ws = Ws2812Simulator::Basic.new(n, 18) # +n+ leds at pin 18, using defaults
ws.open

# first pixel set to red
ws[0] = Ws2812Simulator::Color.new(0xff, 0, 0)

# all other set to green
ws[(1...n)] = Ws2812Simulator::Color.new(0, 0xff, 0)
...
ws.brightness = 5
ws[(0...n)] = Ws2812Simulator::Color.new(0xff, 0, 0)
ws.show
(0...n).each do |i|
	ws[i] = Ws2812Simulator::Color.new(0, 0xff, 0)
	ws.show
	sleep 0.1
end
